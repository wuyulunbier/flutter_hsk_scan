...
- (UIButton *)torchBtn{
    if (_torchBtn == nil) {
        ...
        UIImage *lightImage = [[SDScanMaskView getBundleImageName:@"light@2x"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [_torchBtn setBackgroundImage:lightImage forState:UIControlStateNormal];
        _torchBtn.frame = CGRectMake(KmainWidth/2.0-23, self.hintLabel.bottom + 25.0,46, 46);
    }
    return  _torchBtn;
}
